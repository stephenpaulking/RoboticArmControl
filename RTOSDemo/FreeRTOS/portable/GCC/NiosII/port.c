...
void prvSetupTimerInterrupt( void )
{
	...
	if ( -EINVAL == alt_irq_register( TIMER_IRQ, 0x0, vPortSysTickHandler ) )
	{ 
	...
	else
	{
		...
		IOWR_ALTERA_AVALON_TIMER_PERIODL( TIMER_BASE, ( configCPU_CLOCK_HZ / configTICK_RATE_HZ ) & 0xFFFF );
		IOWR_ALTERA_AVALON_TIMER_PERIODH( TIMER_BASE, ( configCPU_CLOCK_HZ / configTICK_RATE_HZ ) >> 16 );
		IOWR_ALTERA_AVALON_TIMER_CONTROL( TIMER_BASE, ALTERA_AVALON_TIMER_CONTROL_CONT_MSK | ALTERA_AVALON_TIMER_CONTROL_START_MSK | ALTERA_AVALON_TIMER_CONTROL_ITO_MSK );	
	} 
